const en = {
	...
	'projectCenter.action.archive': 'Archive',
	'projectCenter.action.unarchive': 'Unarchive',
	'projectCenter.card.sortLabel': 'Sort',
	...
	'menu.filter.createdCalendarWeek': 'Created: this calendar week',
	'menu.filter.createdCalendarMonth': 'Created: this calendar month',
	...
	'menu.filter.updatedCalendarWeek': 'Updated: this calendar week',
	'menu.filter.updatedCalendarMonth': 'Updated: this calendar month',
	...
	'command.batchClearPriority': 'Batch clear task priority',
	'command.batchSetStarred': 'Batch mark as core task',
	'command.batchClearStarred': 'Batch clear core task mark',
	'command.batchAssignUpTask': 'Batch assign parent task',
	'command.batchRemoveUpTask': 'Batch remove parent task',
	'view.batchBar.count': '{0} selected',
	'view.batchBar.selectAll': 'Select all',
	'view.batchBar.exit': 'Exit batch mode',
	'view.batchBar.delete': 'Delete',
	'view.batchBar.setPriority': 'Set priority',
	'view.batchBar.clearPriority': 'Clear priority',
	'view.batchBar.setStarred': 'Mark core',
	'view.batchBar.clearStarred': 'Unmark core',
	'view.batchBar.assignUpTask': 'Set parent',
	'view.batchBar.removeUpTask': 'Remove parent',
	'modal.batchDelete.title': 'Delete tasks',
	'modal.batchDelete.desc':
		'Move {0} selected task(s) to the trash? This action can be restored from the trash. Child tasks of deleted parent tasks are not deleted and may show broken parent links.',
	'modal.batchDelete.confirm': 'Delete',
	'modal.batchAssignUpTask.title': 'Set parent task',
	'modal.batchAssignUpTask.desc': 'Enter the parent task name for the selected tasks.',
	'modal.batchAssignUpTask.placeholder': 'Parent task name',
	'modal.batchAssignUpTask.confirm': 'Set',
	'notice.batchEdit.noSelection': 'No tasks selected.',
	'notice.batchEdit.priorityDone': 'Updated priority for {0} task(s).',
	'notice.batchEdit.priorityFailed': 'Failed to update priority for {0} task(s).',
	'notice.batchEdit.starredDone': 'Updated core task mark for {0} task(s).',
	'notice.batchEdit.starredFailed':
		'Failed to update core task mark for {0} task(s).',
	'notice.batchEdit.upTaskDone': 'Set parent task for {0} task(s).',
	'notice.batchEdit.upTaskFailed': 'Failed to set parent task for {0} task(s).',
